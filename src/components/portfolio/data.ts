...
export const SERVICES = [
  {
    ...
    desc: "Full-stack builds with React, PHP/Laravel, WordPress, and Shopify — from marketing sites to multi-database platforms.",
    tag: "<web/>",
  },
  {
    title: "Digital Marketing",
    desc: "SEO, paid ad campaigns, and social media marketing that turn traffic into results.",
    tag: "<growth/>",
  },
  {
    title: "App Development",
    desc: "Building functional, user-focused web and app experiences end to end.",
    tag: "<apps/>",
  },
  {
    title: 'AI-Assisted ("Vibe Coding")',
    desc: "Modern AI tooling and prompt engineering to ship faster without cutting corners on quality.",
    tag: "<ai/>",
  },
];
...
export const EXPERIENCE = [
  {
    ...
    bullets: [
      "Owned backend development for Bonikbazar.com (PHP/Laravel, PostgreSQL).",
      "Led SEO improvements that grew organic rankings across properties.",
      "Planned, built, and launched Ispondon.com, hideexpo.com, and bdproperty.xyz.",
      "Ran digital marketing campaigns on bdproperty.xyz driving 5M+ visits.",
      "Built sailtechbd.com on WordPress; managed VPS infrastructure and databases.",
    ],
  },
  {
    ...
    bullets: [
      "Designed and built the frontend of Bonikbazar.com using React.",
      "Promoted to Full Stack Developer after taking on growing backend and infrastructure ownership.",
    ],
  },
  {
...
export const SKILL_GROUPS = [
  {
    title: "Web Development",
    items: ["HTML", "CSS", "JavaScript", "React", "Node.js", "PHP", "Laravel", "WordPress", "Shopify", "MySQL", "PostgreSQL", "Git", "VS Code"],
  },
  {
    title: "Digital Marketing",
    items: ["SEO", "Paid Campaigns", "Social Media Marketing", "Website Behaviour Research"],
  },
  {
    title: "Infrastructure & Tools",
    items: ["VPS / Server Management", "Database Management", "AI & Prompt Engineering", "LLMs", "IT Support"],
  },
  {
    title: "Productivity",
    items: ["Microsoft Word", "Excel", "PowerPoint", "Office Management"],
  },
];
